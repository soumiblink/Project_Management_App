...
export const inviteTeamMember = async (req, res, next) => {
  ...
  <div style="background-color: #FFF; border: 1px solid #e5e5e5; border-radius: 5px; box-shadow: 0px 3px 6px rgba(0,0,0,0.05);">
    ...
    <div style="padding: 30px;">
      ...
      <p style="font-size: 16px; color: #666; margin-bottom: 20px;">You have been invited to join a team <b>${team.name}</b> on PRO by <b>${user.name}</b>. Please follow the link below to accept the invitation:</p>
      ...
      <p style="font-size: 16px; color: #666;">The PRO Team</p>
    </div>
  </div>
</div>
`;
